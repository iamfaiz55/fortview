  ...
  return (
    <section id="gallery" className="py-16 sm:py-20 bg-white">
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.6 }} className="text-center mb-12 sm:mb-16">
        ...
        {/* Main Gallery Grid */}
        <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.15 }} className="grid lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12">
          {galleryItems.map((itemData, index) => (
            <Link key={index} href="/resort/gallery-preview">
              <motion.div 
                variants={item}
                whileHover={{ y: -4 }}
        ...
        <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-10 sm:mb-12">
          {[
            gateSchoolTrip,
            diamondHallWedding,
            turf,
            ...
            <Link key={index} href="/resort/gallery-preview">
              <motion.div variants={item} className="aspect-square overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer group">
                <ImageWithFallback
                  src={image}
        ...
        {/* CTA */}
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.5 }} className="text-center">
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
            <Link href="/resort/gallery-preview">
